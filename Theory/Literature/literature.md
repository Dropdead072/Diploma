...
- [Memory-Constrained Algorithms for Convex Optimization via Recursive Cutting-Planes](https://www.mit.edu/~jaillet/general/2306.10096.pdf)

- [Grokipedia DFP](https://grokipedia.com/page/Davidon–Fletcher–Powell_formula)

- [Chinchilla Point](https://legalgenie.com.au/artificial-intelligence/chinchilla-point/)

- [Benchmarking Optimizers for Large Language Model Pretraining](https://arxiv.org/pdf/2509.01440)

    Статьи про выпуклость (или релаксацию) в нейронках
    - [An Alternative View: When Does SGD Escape Local Minima?](https://arxiv.org/pdf/1802.06175)
